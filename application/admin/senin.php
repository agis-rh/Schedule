                ...
                <div class="box">
                  <header>
                    <div class="icons">
                      ...
                      <h5 class="text-info">DAFTAR DATA JADWAL PELAJARAN HARI SENIN</h5>
                  ...
                  <div id="calendar_content" class="body">
                      <?php
                      $jumlah   =   $fquery->jumlahJadwal('senin');
                      if($jumlah < 1) {
                          echo "<div class='row'><div class='col-md-12'><div class='alert alert-danger'>
                                <h3>Data kosong :</h3>
                                Belum ada data jadwal pelajaran untuk hari senin.<br>
                      ...
                      <table class="table table-bordered table-striped table-hover">
                          ...
                          $jadwal   =   $fquery->pagingJadwal('senin',$posisi,$batas);
                          $no=$posisi+1;
                          ...
                          for($i=1;$i<=$per_page;$i++) {
                            ...
                            if($i!=$per_page) {
                                echo "<li $active><a href='$_SERVER[PHP_SELF]?page=senin&halaman=$i'>$i</a></li>";
                            }
                            else {
                                echo "<li $active><a href='$_SERVER[PHP_SELF]?page=senin&halaman=$i'>$i</a></li>";
                            }
                          ...
                          <br>
                          <br>
                          <a target="_blank" href="laporan.php?jadwal=hari&hari=senin" class="btn btn-primary btn-sm">
