                ...
                <div class="box">
                  <header>
                    <div class="icons">
                      ...
                      <h5 class="text-info">DAFTAR DATA JADWAL PELAJARAN HARI RABU</h5>
                  ...
                  <div id="calendar_content" class="body">
                      <?php
                      $jumlah   =   $fquery->jumlahJadwal('rabu');
                      if($jumlah < 1) {
                          echo "<div class='row'><div class='col-md-12'><div class='alert alert-danger'>
                                <h3>Data kosong :</h3>
                                Belum ada data jadwal pelajaran untuk hari rabu.<br>
                      ...
                      ?>
                      <form action="admin.php?page=multiaksi&hari=rabu&aksi=multi" method="POST">
                      <table class="table table-bordered table-striped table-hover">
                          ...
                          $jadwal   =   $fquery->pagingJadwal('rabu',$posisi,$batas);
                          $no=$posisi+1;
                          foreach ($jadwal as $row) { 
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href="admin.php?page=multiaksi&hari=rabu&aksi=edit_one&id=<?php echo $row['id'];?>">
                          ...
                          for($i=1;$i<=$per_page;$i++) {
                            ...
                            if($i!=$per_page) {
                                echo "<li $active><a href='$_SERVER[PHP_SELF]?page=rabu&halaman=$i'>$i</a></li>";
                            }
                            else {
                                echo "<li $active><a href='$_SERVER[PHP_SELF]?page=rabu&halaman=$i'>$i</a></li>";
                            }
                      ...
                      <div class="alert alert-success">
                          ...
                          <br>
                          <br>
                          <a target="_blank" href="laporan.php?jadwal=hari&hari=rabu" class="btn btn-primary btn-sm">
                                        ...
                                        <a class="btn btn-sm btn-danger" onclick="reset();">
                                         ...
                                         <div class="modal-body">
                                           <div class="form-jadwal">
                                             <form action="admin.php?page=tambah&hari=rabu" method="POST">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="admin.php?page=multiaksi&hari=rabu&aksi=hapus_one&id=<?php echo $hapus['id'];?>"
