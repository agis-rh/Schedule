                ...
                <div class="box">
                  <header>
                    <div class="icons">
                      ...
                      <h5 class="text-info">DAFTAR DATA JADWAL PELAJARAN HARI SELASA</h5>
                  ...
                  <div id="calendar_content" class="body">
                      <?php
                      $jumlah   =   $fquery->jumlahJadwal('selasa');
                      if($jumlah < 1) {
                          echo "<div class='row'><div class='col-md-12'><div class='alert alert-danger'>
                                <h3>Data kosong :</h3>
                                Belum ada data jadwal pelajaran untuk hari selasa.<br>
                      ...
                      ?>
                      <form action="admin.php?page=multiaksi&hari=selasa&aksi=multi" method="POST">
                      <table class="table table-bordered table-striped table-hover">
                          ...
                          $jadwal   =   $fquery->pagingJadwal('selasa',$posisi,$batas);
                          $no=$posisi+1;
                          foreach ($jadwal as $row) {
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a href="admin.php?page=multiaksi&hari=selasa&aksi=edit_one&id=<?php echo $row['id'];?>">
                          ...
                          for($i=1;$i<=$per_page;$i++) {
                            ...
                            if($i!=$per_page) {
                                echo "<li $active><a href='$_SERVER[PHP_SELF]?page=selasa&halaman=$i'>$i</a></li>";
                            }
                            else {
                                echo "<li $active><a href='$_SERVER[PHP_SELF]?page=selasa&halaman=$i'>$i</a></li>";
                            }
                      ...
                      <div class="alert alert-success">
                          ...
                          <br>
                          <br>
                          <a target="_blank" href="laporan.php?jadwal=hari&hari=selasa" class="btn btn-primary btn-sm">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <a class="btn btn-sm btn-danger" onclick="reset();">
                                         ...
                                         <div class="modal-body">
                                             ...
                                             <form action="admin.php?page=tambah&hari=selasa" method="POST">
                                                <div class="form-group">
                                                    <label class="control-label col-lg-4">Waktu jam mulai </label>
                                                    <div class="col-lg-8">
                                                        <input type="text" maxlength="5" required name="mulai" class="form-control col-lg-6">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-lg-4">Waktu jam selesai </label>
                                                    <div class="col-lg-8">
                                                      <input type="text" maxlength="5" required name="selesai" class="form-control col-lg-6">
                                                    </div>
                                                </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="admin.php?page=multiaksi&hari=selasa&aksi=hapus_one&id=<?php echo $hapus['id'];?>"
